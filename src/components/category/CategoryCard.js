  ...
  return (
    <>
      <a
        ...
        className="p-2 flex items-center rounded-md hover:bg-gray-50 w-full hover:text-[#5faf34]"
        role="button"
      >
        {icon ? (
        ...
        <div className="inline-flex items-center justify-between ml-3 text-sm font-medium w-full hover:text-[#5faf34]">
          {title}
          {nested?.length > 0 && (
            ...
            <li key={children._id}>
              {children.children.length > 0 ? (
                <a
                  ...
                  className="flex items-center font-serif pr-2 text-sm text-gray-600 hover:text-[#5faf34] py-1 cursor-pointer"
                >
                ...
                <a
                  ...
                  className="flex items-center font-serif py-1 text-sm text-gray-600 hover:text-[#5faf34] cursor-pointer"
                >
