export const storeCustomization = {
  ...
  home: {
    ...
    quick_delivery_description: {
      en: "There are many products you will find in our shop, Choose your daily necessary product from our satvacare shop and get some special offers. See Our latest discounted products from here and get a special discount.",
      de: "Es gibt viele Produkte, die Sie in unserem Shop finden. Wählen Sie Ihr täglich benötigtes Produkt aus unserem satvacare-Shop und erhalten Sie einige Sonderangebote. Sehen Sie sich hier unsere neuesten reduzierten Produkte an und sichern Sie sich einen Sonderrabatt.",
    },
    ...
    daily_need_title: {
      en: "Get Your Daily Needs From Our satvacare Store",
      de: "Holen Sie sich Ihren täglichen Bedarf in Ihrem CloudCleaver-Shop",
    },
    daily_need_description: {
      en: "There are many products you will find in our shop, Choose your daily necessary product from our satvacare shop and get some special offers.",
      de: "Es gibt viele Produkte, die Sie in unserem Shop finden. Wählen Sie Ihr täglich benötigtes Produkt aus unserem satvacare-Shop und erhalten Sie einige Sonderangebote.",
    },
  ...
  about_us: {
    ...
    top_title: {
      en: "Welcome to our SatvaCare shop",
      de: "Willkommen in unserem SatvaCare-Shop",
    },
    top_description: {
  ...
  faq: {
    ...
    faq_five: {
      en: "What is satvacare EC2 auto scaling?",
      de: "Was ist die automatische Skalierung von satvacare EC2?",
    },
    description_five: {
      en: "Continually impact seamless imperatives for best-of-breed best practices. Phosfluorescently facilitate parallel applications with unique imperatives. Proactively plagiarize functionalized deliverables via inexpensive solutions. Collaboratively embrace web-enabled infomediaries rather than diverse testing procedures.",
    ...
    faq_six: {
      en: "What are the benefits of using satvacare affliate?",
  ...
  footer: {
    ...
    block4_address: {
      en: "At Movaiya, Beside World Steel, Paddhari - Mitana Road, Paddhari, Rajkot - Gujarat.",
      de: "At Movaiya, Beside World Steel, Paddhari - Mitana Road, Paddhari, Rajkot - Gujarat.",
    },
    block4_phone: "+91 88 66 908 906",
    block4_email: "shasvatcropscience@gmail.com",
  ...
  seo: {
    ...
    meta_title:
      "SatvaCare - React Grocery & Organic Food Store e-commerce Template",
    meta_url: "https://SatvaCare-store-nine.vercel.app/",
  },
};
